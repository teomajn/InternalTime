...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 64.0, 40.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 8.0, 116.0, 20.0 ],
					"text" : "o.io.bluetoothle.hrm"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "o.io.bluetoothle.hrm.maxpat",
				"bootpath" : "/Users/john/Development/CNMAT/CNMAT-Internal/personal/johnmac/testing/io",
				"patcherrelativepath" : "../../CNMAT/CNMAT-Internal/personal/johnmac/testing/io",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
